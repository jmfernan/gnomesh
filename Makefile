...
pkgdatadir = $(datadir)/gnomesh
pkglibdir = $(libdir)/gnomesh
pkgincludedir = $(includedir)/gnomesh
top_builddir = .

ACLOCAL = ${SHELL} /root/Proyectos/gnomesh/missing --run aclocal-1.6
AUTOCONF = ${SHELL} /root/Proyectos/gnomesh/missing --run autoconf
AUTOMAKE = ${SHELL} /root/Proyectos/gnomesh/missing --run automake-1.6
AUTOHEADER = ${SHELL} /root/Proyectos/gnomesh/missing --run autoheader
...
OBJEXT = o
PATH_SEPARATOR = :
AMTAR = ${SHELL} /root/Proyectos/gnomesh/missing --run tar
AWK = gawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
am__include = include
am__quote = 
install_sh = /root/Proyectos/gnomesh/install-sh
